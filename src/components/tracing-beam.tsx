    ...
    <motion.div ref={ref} className={cn('relative w-full', className)}>
      <div className="absolute -left-4 md:-left-8 top-3">
        <motion.div
          ...
          animate={{
            boxShadow: scrollYProgress.get() > 0 ? '0 0 20px rgba(212, 175, 55, 0.3)' : 'none',
          }}
          className="ml-[27px] h-4 w-4 rounded-full border border-primary/50 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="hsl(var(--card))" stopOpacity="0"></stop>
              <stop stopColor="hsl(var(--card))"></stop>
